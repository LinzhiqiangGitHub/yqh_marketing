package com.yqh.marketing.basedevss.base.io;


import com.yqh.marketing.basedevss.ServerException;
import com.yqh.marketing.basedevss.base.BaseErrors;
import com.yqh.marketing.basedevss.base.data.Null;
import com.yqh.marketing.basedevss.base.data.Privacy;
import com.yqh.marketing.basedevss.base.data.Values;
import com.yqh.marketing.basedevss.base.util.json.JsonUtils;
...
public class IOUtils2 {
    ...
    public static byte[] toBytes(com.yqh.marketing.basedevss.base.io.Serializable o) {
        Validate.notNull(o);
    ...
    public static <T extends com.yqh.marketing.basedevss.base.io.Serializable> T fromBytes(Class<T> type, byte[] bytes, int off, int len) {
    ...
    public static <T extends com.yqh.marketing.basedevss.base.io.Serializable> T fromBytes(Class<T> type, byte[] bytes) {
        return fromBytes(type, bytes, 0, bytes.length);
    }

    public static ByteBuffer toByteBuffer(com.yqh.marketing.basedevss.base.io.Serializable o) {
        return ByteBuffer.wrap(toBytes(o));
    }


    public static <T extends com.yqh.marketing.basedevss.base.io.Serializable> T fromByteBuffer(Class<T> type, ByteBuffer byteBuff, int off, int len) {
    ...
    public static <T extends com.yqh.marketing.basedevss.base.io.Serializable> T fromByteBuffer(Class<T> type, ByteBuffer byteBuff) {
