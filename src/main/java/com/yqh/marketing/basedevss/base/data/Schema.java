...
import com.yqh.marketing.basedevss.base.io.TextLoader;
import com.yqh.marketing.basedevss.base.util.Copyable;
import com.yqh.marketing.basedevss.base.util.ImmutableNamed;
...
public class Schema extends ImmutableNamed implements Copyable<Schema> {
    ...
    public static class Column extends ImmutableNamed implements Copyable<Column> {
        ...
        private Column(String name, DataType type, String alias) {
            ...
            Validate.isTrue(ArrayUtils.contains(new Object[]{DataType.BOOLEAN, DataType.INT, DataType.FLOAT, DataType.STRING, DataType.JSON}, type));
            this.type = type;
